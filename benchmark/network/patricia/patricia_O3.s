...
main:
	addi	sp,sp,-80
	sw	s10,32(sp)
	lui	s10,%hi(node_count)
	sw	s5,52(sp)
	lw	s5,%lo(node_count)(s10)
	li	a4,12288
	sw	ra,76(sp)
	addi	a4,a4,-289
	bgt	s5,a4,.L180
	...
	lui	s6,%hi(mask_count)
	slli	a5,a5,2
	addi	s8,s8,%lo(static_nodes)
	lw	a2,%lo(mask_count)(s6)
	add	a1,s8,a5
	addi	a0,s5,1
	sw	zero,0(a1)
	sw	zero,4(a1)
	...
	sw	zero,12(a1)
	sw	zero,16(a1)
	sw	a0,%lo(node_count)(s10)
	bgt	a2,a4,.L247
	lui	a6,%hi(static_masks)
	lui	a7,%hi(data_count)
	sw	s9,36(sp)
	slli	a3,a2,3
	addi	a6,a6,%lo(static_masks)
	lw	s9,%lo(data_count)(a7)
	add	a3,a6,a3
	addi	a2,a2,1
	sw	a3,4(a1)
	sw	zero,0(a3)
	sw	zero,4(a3)
	sw	a2,%lo(mask_count)(s6)
	bgt	s9,a4,.L243
	li	a4,20
	mul	a4,s5,a4
	sw	s4,56(sp)
	...
	sw	s1,68(sp)
	sw	s3,60(sp)
	addi	s4,s4,%lo(test_data)
	lui	s3,%hi(static_data)
	addi	s1,s8,20
	addi	s3,s3,%lo(static_data)
	slli	a2,s9,4
	add	s1,s1,a5
	lw	a5,0(s4)
	sw	s0,72(sp)
...
.L197:
	...
	sw	zero,0(a4)
	sw	zero,4(a4)
	sw	a5,%lo(mask_count)(s6)
	beq	t5,s7,.L245
	mul	a5,t0,t6
	sub	a3,s9,s5
	add	a3,a3,t5
	sb	zero,0(s3)
	sw	a3,%lo(data_count)(a7)
	mv	a3,a1
	lw	a2,4(a3)
	sw	t3,0(a4)
	li	t0,-2147483648
...
.L213:
	...
	lui	a5,%hi(static_masks)
	lui	a7,%hi(data_count)
	addi	a6,a5,%lo(static_masks)
	li	t1,45
	li	t4,43
	li	t3,-1
	bne	a0,zero,.L214
