...
.L193:
	...
	addi	a0, s0, 0
.Lpcrel_1:
	auipc	ra, %pcrel_hi(_nettle_sha256_compress)
...
.L368:
	...
	sw	zero,104(sp)
.Lpcrel_7:
	auipc	ra, %pcrel_hi(sha256_update.constprop.0)
	jalr	ra, ra, %pcrel_lo(.Lpcrel_7)
	addi	a0, sp, 0
	addi	s1,s1,1
.Lpcrel_8:
	auipc	ra, %pcrel_hi(sha256_write_digest.constprop.0)
...
.Lpcrel_12:
	...
	addi	a0, s2, 0
.Lpcrel_13:
	auipc	ra, %pcrel_hi(_nettle_write_be32)
